...
In the end Bolt is just a Node.js app, and you deploy it to Heroku like any other Node app. See this [article](https://devcenter.heroku.com/articles/deploying-nodejs) for help.
